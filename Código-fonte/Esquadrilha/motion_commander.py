...
class MotionCommander:
    ...
    def setStopMotion(self, value):
        self._stopMotion = value

    def getStopMotion(self):
        return self._stopMotion

    def safeSleep(self, flight_time):
        '''substitui o time.sleep, de modo que seja possível parar o motor
        no meio do movimento. Utilizado para realizar o pouso de emergencia'''
        timer = 0;
    ...
    def down(self, distance_m, velocity=VELOCITY):
        ...
        :return:
        """
        self.move_distance_land(0.0, 0.0, -distance_m, velocity)
    ...
    def move_distance_land(self, distance_x_m, distance_y_m, distance_z_m,
                      velocity=VELOCITY):
        """
        Move in a straight line.
        positive X is forward
